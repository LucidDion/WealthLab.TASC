...
namespace WealthLab.TASC
{
    public class QuotientTransform : IndicatorBase
    {
        ...
        //static method
        public static QuotientTransform Series(TimeSeries source, int period, double k)
        {
            string key = CacheKey("QuotientTransform", period, k);
            if (source.Cache.ContainsKey(key))
                return (QuotientTransform)source.Cache[key];
            QuotientTransform qt = new QuotientTransform(source, period, k);
            source.Cache[key] = qt;
            return qt;
        }
        ...
        protected override void GenerateParameters()
        {
            ...
            AddParameter("Low-pass Period", ParameterType.Int32, 30);
            AddParameter("Quotient K", ParameterType.Double, 0.85);
        }
        ...
        public override WLColor DefaultColor => WLColor.DarkOrange;
