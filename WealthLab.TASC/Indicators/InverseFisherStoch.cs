...
namespace WealthLab.TASC
{
    ...
    public class InverseFisherStoch : IndicatorBase
    {
            ...
            : base()
        {
            ...
            Parameters[2].Value = smooth;

            Populate();
        }

        //static method
        public static InverseFisherStoch Series(TimeSeries source, int stoPeriod, int smooth)
        {
            string key = CacheKey("InverseFisherStoch", stoPeriod, smooth);
            if (source.Cache.ContainsKey(key))
                return (InverseFisherStoch)source.Cache[key];
            InverseFisherStoch ifS = new InverseFisherStoch(source, stoPeriod, smooth);
            source.Cache[key] = ifS;
            return ifS;
        }
        ...
        protected override void GenerateParameters()
        {
            ...
            AddParameter("Stoch Period", ParameterType.Int32, 30);
            AddParameter("Smooth Period", ParameterType.Int32, 5);
        }
