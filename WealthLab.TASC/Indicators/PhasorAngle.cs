...
{
    public class PhasorAngle : IndicatorBase
    {
        public override string Name => "PhasorAngle";
        public override string Abbreviation => "PhasorAngle";
        public override string HelpDescription => "The Phasor Angle indicator by Dr. John Ehlers from S&C October 2022 issue.";
        public override string PaneTag => "PhasorAngle";
        ...
        public PhasorAngle(TimeSeries ds, int period = 28)
        {
        ...
        //static method
        public static PhasorAngle Series(TimeSeries source, int period = 28)
        {
            string key = CacheKey("PhasorAngle", period);
            if (source.Cache.ContainsKey(key))
                return (PhasorAngle)source.Cache[key];
            PhasorAngle pa = new PhasorAngle(source, period);
            source.Cache[key] = pa;
            return pa;
        }
