...
namespace WealthLab.TASC
{
    public class SVESmoothedVolatilityBandLower : IndicatorBase
    {
        ...
        //static method
        public static SVESmoothedVolatilityBandLower Series(BarHistory source, int bandAverage, int volSumPeriod, double devFactor, double lowBandAdj)
        {
            string key = CacheKey("SVESmoothedVolatilityBandLower", bandAverage, volSumPeriod, devFactor, lowBandAdj);
            if (source.Cache.ContainsKey(key))
                return (SVESmoothedVolatilityBandLower)source.Cache[key];
            SVESmoothedVolatilityBandLower sve = new SVESmoothedVolatilityBandLower(source, bandAverage, volSumPeriod, devFactor, lowBandAdj);
