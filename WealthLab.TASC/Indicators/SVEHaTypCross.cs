...
namespace WealthLab.TASC
{
    public class SVEHaTypCross : IndicatorBase
    {
        ...
        //static method
        public static SVEHaTypCross Series(BarHistory source, int haPeriod, int typPeriod)
        {
            string key = CacheKey("SVEHaTypCross", haPeriod, typPeriod);
            if (source.Cache.ContainsKey(key))
                return (SVEHaTypCross)source.Cache[key];
            SVEHaTypCross sve = new SVEHaTypCross(source, haPeriod, typPeriod);
        ...
        protected override void GenerateParameters()
        {
            ...
            AddParameter("Heikin-Ashi Period", ParameterType.Int32, 8);
            AddParameter("Typical period", ParameterType.Int32, 5);
        }
