...
namespace WealthLab.TASC
{
    ...
    public class PTBar : IndicatorBase
    {
            ...
            : base()
        {
            ...
            Parameters[1].Value = reversal;

            Populate();
        }

        //static method
        public static PTBar Series(TimeSeries source, double reversal)
        {
            string key = CacheKey("PTBar", reversal);
            if (source.Cache.ContainsKey(key))
                return (PTBar)source.Cache[key];
            PTBar p = new PTBar(source, reversal);
            source.Cache[key] = p;
            return p;
        }
        ...
        protected override void GenerateParameters()
        {
            ...
            AddParameter("ReversalPct", ParameterType.Double, 3.3);
        }
